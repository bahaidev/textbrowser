...
// Defines a constant required for the password file to be accessed, then accesses the password file (with login, table, etc. data)
...
// print $strings["$stringkey2"]."<hr />\n";
	...
	require('semidynamic_variable.php');
...
// The following immediate variables could be changed in the future if the user opted for the display to instead show paragraphs (or Basic XHTML for mobile phone users), etc.
	...
	if ($outputmode == "pspan") {
		...
		// Required for body
		$smarty->assign('tr2open', "p");
		$smarty->assign('tr2close', "p");
		$smarty->assign('tdopen', "span");
		$smarty->assign('tdclose', "span");
		// Optional
		$smarty->assign('tr2divider', "");
		$smarty->assign('tddivider', "---");
	...
	elseif ($outputmode == "li") {
		...
		// Required for headings
		$smarty->assign('tr1open', "<ul");
		$smarty->assign('tr1close', "ul");
		...
		// Required for body
		$smarty->assign('tr2open', "ul");
		$smarty->assign('tr2close', "ul");
		$smarty->assign('tdopen', "li");
		$smarty->assign('tdclose', "li");
		// Optional
		$smarty->assign('tr2divider', "");
		$smarty->assign('tddivider', "---");
	...
	elseif ($outputmode == "span") {
		...
		// Required for headings
		$smarty->assign('tr1open', "<span");
		$smarty->assign('tr1close', "span");
		$smarty->assign('thopen', "<span");
		$smarty->assign('thclose', "span");
		// Optional
		$smarty->assign('tr1divider', "");
		...
		// Required for body
		$smarty->assign('tr2open', "span");
		$smarty->assign('tr2close', "span");
		$smarty->assign('tdopen', "span");
		$smarty->assign('tdclose', "span");
		// Optional
		$smarty->assign('tr2divider', "");
	...
	elseif ($outputmode == "p") {
		...
		// Required for body
		$smarty->assign('tr2open', "div");
		$smarty->assign('tr2close', "div");
		$smarty->assign('tdopen', "p");
		$smarty->assign('tdclose', "p");
...
//	The following are presently only for table, and as such, are being added statically to the template:
		...
		$smarty->assign('theadopen', "<thead id='maintablehead'>");
		$smarty->assign('theadclose', "</thead>");
...
*/
		$smarty->assign('tbodyopen', "<tbody id='maintablebody'>");
		$smarty->assign('tbodyclose', "</tbody>");
		...
		// Required for body
		$smarty->assign('tr2open', "tr");
		$smarty->assign('tr2close', "tr");
		$smarty->assign('tdopen', "td");
...
require_once ('headerpreptoadd.php');


///////// Table-specific data

$fields_name1 = $browse_field_A;
...
$fields_name2 = $browse_field_B;
$fields_name3 = $browse_field_C;
