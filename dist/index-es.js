...
class Dialog {
  ...
  makeDialog({
    ...
    jmlExports.jml('dialog', atts, children, jmlExports.$('#main'));
    dialog.showModal();
    if (remove) {
  ...
  makeSubmitDialog({
    ...
    $e(dialog, `button.${args.cancelClass || 'cancel'}`).before(jmlExports.jml('button', {
      class: submitClass,
      $on: {
        click(e) {
          if (submit) {
    ...
    }, [this.localeStrings.submit]), jmlExports.nbsp.repeat(2));
    return dialog;
  }
  ...
  alert(message, ok) {
    ...
    return new Promise(resolve => {
      const dialog = /** @type {HTMLDialogElement} */jmlExports.jml('dialog', [msg, ...(includeOk ? (/** @type {import('jamilih').JamilihChildren} */[['br'], ['br'], ['div', {
        class: submitClass
      }, [['button', {
        $on: {
          click() {
      ...
      }, [this.localeStrings.ok]]]]]) : [])], jmlExports.$('#main'));
      dialog.showModal();
    });
  }
  /**
  ...
  prompt(message) {
    ...
    return new Promise((resolve, reject) => {
      ...
      this.makeSubmitDialog({
        ...
        children: [['label', [msg, jmlExports.nbsp.repeat(3), ['input']]]]
      });
    });
  }
  /**
  ...
  confirm(message) {
    ...
    return new Promise((resolve, reject) => {
      const dialog = /** @type {HTMLDialogElement} */jmlExports.jml('dialog', [msg, ['br'], ['br'], ['div', {
        class: submitClass
      }, [['button', {
        $on: {
          click() {
      ...
      }, [this.localeStrings.ok]], jmlExports.nbsp.repeat(2), ['button', {
        $on: {
          click() {
            dialog.close();
            reject(new Error('cancelled'));
      ...
      }, [this.localeStrings.cancel]]]]], jmlExports.$('#main'));
      dialog.showModal();
    });
  }
}
...
const getWorkData = async function ({
  ...
  const filesObj = /** @type {FilesObject} */await distExports$1.getJSON(files);
...
var languageSelect = {
  ...
  main({
    ...
    if (history.state && typeof history.state === 'object') {
      distExports.deserialize(document.querySelector('#languageSelectionContainer'), history.state);
    }
  }
...
const workSelect$1 = function ({
  ...
  const form = jmlExports.jml('form', {
    id: 'workSelect',
    class: 'focus',
    $on: {
      submit(e) {
  ...
  if (history.state && typeof history.state === 'object') {
    distExports.deserialize(document.querySelector('#workSelect'), history.state);
  }
  return form;
};
...
const nbsp2 = jmlExports.nbsp.repeat(2);
const nbsp3 = jmlExports.nbsp.repeat(3);
const getDataForSerializingParamsAsURL = () => ({
  form: (/** @type {HTMLFormElement} */jmlExports.$('form#browse')),
  // Todo: We don't need any default once random
  //    functionality is completed
  random: /** @type {HTMLInputElement} */jmlExports.$('#rand') || {
    checked: false
  },
  checkboxes: (/** @type {HTMLInputElement[]} */jmlExports.$$('input[type=checkbox]'))
});
var workDisplay$1 = {
  /**
   * @param {{
  ...
  /*
    ...
    $on: {
      click() {
        ...
        jmlExports.$$('.fieldSelector').forEach(checkbox => {
    ...
    $on: {
      click() {
        fieldInfo.forEach((/* {field} */_, i) => {
          ...
          /** @type {HTMLSelectElement} */jmlExports.$('#field' + idx).selectedOptions[0].dataset.name;
          /** @type {HTMLInputElement} */
          jmlExports.$('#checked' + idx).checked = fieldMatchesLocale(fld);
        });
      }
    }
  })]]]]]],
  ...
  })]]], ['label', [jmlExports.nbsp, lDirectional('or_entercolor'), nbsp2, ['input', {
    name: lParam('color'),
    type: 'text',
    value: $p.get('color') || '#',
    size: '7',
  ...
  }], lDirectional(['param_values', 'fontvariant', 'normal']), jmlExports.nbsp]], ['label', [['input', {
    name: lParam('fontvariant'),
    type: 'radio',
    value: l(['param_values', 'fontvariant', 'small-caps']),
    checked: $p.get('fontvariant') === lDirectional(['param_values', 'fontvariant', 'small-caps'])
  }], lDirectional(['param_values', 'fontvariant', 'small-caps']), jmlExports.nbsp]]]], ['br'], ['label', [
  ...
  ['label', {
    dir: 'ltr'
  }, [lDirectional('font_stretch'), jmlExports.nbsp, ['select', {
  ...
  addRandomFormFields({
    ...
    ['label', [lDirectional('rnd'), nbsp3, ['input', {
    ...
    }]]], nbsp3, ['label', [lDirectional('verses-context'), jmlExports.nbsp, ['input', {
      name: lParam('context'),
      type: 'number',
      min: 1,
      size: 4,
      ...
      $on: {
        click() {
          ...
          /** @type {HTMLInputElement} */
          jmlExports.$('#randomURL').value = url;
        }
      }
    }), ['input', {
      id: 'randomURL',
  ...
  getPreferences: ({
    ...
    $on: {
      change(e) {
        ...
        const checked = /** @type {HTMLInputElement} */e.target.checked;
        /** @type {HTMLElement} */
        jmlExports.$('#advancedformatting').style.display = checked ? 'none' : 'block';
        ...
        return browseFields.reduce((rowContent, {
          ...
          rowContent['#'].push(['td', [['label', {
            ...
            $on: setType === 'start' ? {
              ...
              change(e) {
                /** @type {HTMLInputElement[]} */
                jmlExports.$$('input.browseField').forEach(bf => {
  ...
  */
  main({
    ...
    jmlExports.jml('div', {
      ...
      $on: {
        click() {
          const prefs = /** @type {HTMLElement} */jmlExports.$('#preferences');
      ...
      $on: {
        click() {
          ...
          /** @type {HTMLInputElement} */
          jmlExports.$('#settings-URL').value = url;
        }
      }
    }), ['input', {
      id: 'settings-URL'
...
var resultsDisplayClient$1 = {
  ...
  anchorRowCol({
    ...
    return jmlExports.$('#' + anchorRowCol);
  },
  /**
   * @param {{
   *   escapedRow: string
  ...
  main(args) {
    ...
    jmlExports.jml(...html, jmlExports.$('#main'));
  }
};
...
const Templates = {
  ...
  defaultBody() {
    ...
    while (jmlExports.body.hasChildNodes()) {
      jmlExports.body.firstChild?.remove();
    }
    return jmlExports.jml('div', {
      id: 'main',
      role: 'main'
    }, jmlExports.body);
  },
  permissions: {
    versionChange() {
      /** @type {HTMLDialogElement} */
      jmlExports.$('#versionChange')?.showModal();
    },
    /**
    ...
    addLogEntry({
      ...
      const installationDialog = jmlExports.$('#installationLogContainer');
      try {
        /** @type {HTMLDialogElement} */
        installationDialog.showModal();
        const container = /** @type {HTMLElement} */jmlExports.$('#dialogContainer');
        container.hidden = false;
      } catch (err) {
        // May already be open
      }
      /** @type {HTMLElement} */
      jmlExports.$('#installationLog').append(text + '\n');
    },
    exitDialogs() {
      const container = jmlExports.$('#dialogContainer');
      if (container) {
    ...
    dbError({
      ...
      if (type) {
        jmlExports.jml('span', [type, ' ', escapedErrorMessage], jmlExports.$('#dbError'));
      }
      /** @type {HTMLDialogElement} */
      jmlExports.$('#dbError').showModal();
    },
    /**
    ...
    errorRegistering(escapedErrorMessage) {
      if (escapedErrorMessage) {
        jmlExports.jml('span', [escapedErrorMessage], jmlExports.$('#errorRegistering'));
      }
      /** @type {HTMLDialogElement} */
      jmlExports.$('#errorRegistering').showModal();
    },
    browserNotGrantingPersistence() {
      /** @type {HTMLDialogElement} */
      jmlExports.$('#browserNotGrantingPersistence').showModal();
    },
    /**
     * @param {object} cfg
    ...
    main({
      ...
      const installationDialog = jmlExports.jml('dialog', {
      ...
      if (ok && refuse && close) {
        requestPermissionsDialog = jmlExports.jml('dialog', {
      ...
      const errorRegisteringNotice = jmlExports.jml('dialog', {
        id: 'errorRegistering'
      ...
      if (closeBrowserNotGranting) {
        browserNotGrantingPersistenceAlert = jmlExports.jml('dialog', {
      ...
      const versionChangeNotice = jmlExports.jml('dialog', {
        id: 'versionChange'
      }, [['section', [siteI18n('versionChange')]]]);
      const dbErrorNotice = jmlExports.jml('dialog', {
        id: 'dbError'
      }, [['section', [siteI18n('dbError')]]]);
      jmlExports.jml('div', {
        id: 'dialogContainer',
        style: 'height: 100%'
      }, [installationDialog, requestPermissionsDialog, browserNotGrantingPersistenceAlert, errorRegisteringNotice, versionChangeNotice, dbErrorNotice], jmlExports.$('#main'));
...
const getParamsSetter = function ({
  ...
  return function ({
    ...
    const formParamsHash = distExports.serialize(form, {
      hash: true,
      empty: true
    });
...
async function workDisplay({
  ...
  async function _displayWork({
    ...
    */
    ...
    await distExports$1.getJSON(this.files);
...
class TextBrowser {
  ...
  async init() {
    ...
    try {
       ...
       * ]}
       */
      await distExports$1.getJSON([this.languages, this.site]);
  ...
  async paramChange() {
    ...
    const followParams = (formSelector, cb) => {
      ...
      history.replaceState(distExports.serialize(form, {
        hash: true,
        empty: true
      }), document.title, url);
